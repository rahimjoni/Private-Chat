                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a @click.prevent="deleteall" class="dropdown-item" href="#">Delete All</a>
                        </div>
                    </li>
                        ...
                        <div class="message-data align-right">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">...</a>
                                    <div class="dropdown-menu">
                                        <a @click.prevent="singleMessageDelete(message.id)" class="dropdown-item" href="#">Delete</a>
                                    </div>
                                </li>
